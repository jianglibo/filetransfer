package cn.intellijoy.vertx.filetransfer.integration.clojure;
...
@TestVerticleInfo(filenameFilter = "verify_verticle_test.clj", funcRegex = "defn[\\s]+(test[^\\s]+)")
public class VerifyVerticleItTest {
