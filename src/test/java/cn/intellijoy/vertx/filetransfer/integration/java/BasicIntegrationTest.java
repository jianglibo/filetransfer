...
public class BasicIntegrationTest extends TestVerticle {
  ...
  @Test
  public void testDeployFileServer() {
    container.deployVerticle("file_server.clj", new AsyncResultHandler<String>() {
      @Override
  ...
  // @Test
  // /*
  // This test deploys some arbitrary verticle - note that the call to testComplete() is inside the
  // Verticle `SomeVerticle`
  // */
